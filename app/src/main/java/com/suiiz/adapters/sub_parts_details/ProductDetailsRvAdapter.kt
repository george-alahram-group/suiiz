...
import com.suiiz.databinding.ItemRvProductsImagesBinding

class ProductDetailsRvAdapter : RecyclerView.Adapter<ProductDetailsRvAdapter.CardsBrandViewHolder>() {

    companion object const private val TAG = "SubPartDetailsVp2Adapter"

    inner class CardsBrandViewHolder(val binding:ItemRvProductsImagesBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        CardsBrandViewHolder(
            ItemRvProductsImagesBinding.inflate(
